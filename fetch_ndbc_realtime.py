...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/?redir=%2Ffiles%2Fsvdesai75%2FF49P0F51N%2Ffetch_ndbc_realtime.py&amp;nojsmode=1" /></noscript>
...
<script>TSSSB.env = (function() {
    ...
    <meta name="robots" content="noindex,nofollow">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/8e44/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<!-- output_css "file_pages" -->
		...
		<!-- output_css "regular" -->
    <link href="https://a.slack-edge.com/604ba/style/signin.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    <link href="https://a.slack-edge.com/33749/style/index.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/5d87a/style/sticky_nav.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    <link href="https://a.slack-edge.com/fdce4/style/footer.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
...
<div class="real_content card align_center span_4_of_6 col float_none margin_auto large_bottom_margin right_padding large_bottom_padding">
	...
	Sign in to <span class="break_word">IoT Fuse</span>
	</h1>

	<p class="medium_bottom_margin">iotfuse.slack.com</p>
	...
	<div class="col span_4_of_6 float_none margin_auto signin_card">
		<form id="signin_form" action="/" method="post" accept-encoding="UTF-8">
			...
			<input type="hidden" name="redir" value="/files/svdesai75/F49P0F51N/fetch_ndbc_realtime.py">
						<input type="hidden" name="crumb" value="s-1488049710-2e37713fce-☃" />

			<p class="browser_password">Enter your <strong>email address</strong> and <strong>password</strong>.</p>
			...
			<span class="float_left "><label class="checkbox normal"><input type="checkbox" name="remember" checked> Keep me signed in</label></span>

							<span class="float_right"><a id="forgot-pw" href="/forgot">Forgot password?</a></span>
										<p id="forgot_email" class="small no_bottom_margin clear_both taller_line_height"><a href="https://slack.com/signin/find" class="bold">I forgot which email address I used</a></p>

			
		</form>
		<div id="magic_login_cta" class="float_none margin_auto hidden">

   		<div class="or small_top_padding medium_bottom_margin align_center">or</div>
			...
			<form id="magic_login" action="/" method="post" accept-encoding="UTF-8" class="align_center float_none margin_auto medium_bottom_margin">
				...
				<button class="btn btn_large btn_outline full_width"><ts-icon class="ts_icon_magic"></ts-icon>Email Me A Magic Link</button>
			</form>
			<p><strong>Long password? Hard to type?</strong><br /> We can email you a magic link so you can sign in without having to type your password.</p>
...
<div class="real_content align_center">
			<p>
			<span class="bold">Don't have an account on this team yet?</span>
			<span class="clear_both block">Contact the team administrator for an invitation</span>
		</p>
	...
	<a data-clog-event="WEBSITE_CLICK" data-clog-params="click_target=inc_download_app_or_sign_in_cta_sign_up_link" href="/create" class="bold">Create a new team</a>
			</p>
	</div>
...
<script type="text/javascript" src="https://a.slack-edge.com/afa05/js/TS.i18n.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/f3a1f/js/TS.clog.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/5152e/js/libs/warn_capslock.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<!-- slack-www-hhvm-0281ed431b3e012bd / 2017-02-25 11:08:30 / v2c734e50a71d71b1b261ff1bb214b8edb2b2422d / B:H -->
